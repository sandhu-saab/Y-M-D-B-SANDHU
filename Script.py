...
Mᴇꜱꜱᴀɢᴇ : <b>{}</b>"""
    ...
    MOVIE_UPDATE_NOTIFY_TXT = """​<b>【{filename}】🆕️ | <a href={imdb_url}>⭐ ɪᴍᴅʙ ɪɴғᴏ</a>\n\n📺 Oᴛᴛ : {ott}\n🔥 Rᴀᴛɪɴɢ : {rating}★\n🎞️ Fᴏʀᴍᴀᴛ : {format}\n🖼️ Pɪxᴇʟs : {pixels}\n🎧 Aᴜᴅɪᴏ : {language}\n🎭 Gᴇɴʀᴇs : {genres}\n\n<blockquote>𝖴𝗉𝗅𝗈𝖺𝖽𝖾𝖽 𝖡𝗒 - @OttSandhu</blockquote></b>"""
...
⏰Rᴇꜱᴜʟᴛ Sʜᴏᴡɴ ɪɴ: {remaining_seconds} <i>seconds</i> 🔥
RᴇQᴜᴇꜱᴛᴇᴅ Bʏ : {message.from_user.mention}</b>"""
...
•─────•─────────•─────•
🏷️ <a href='https://t.me/Baii_Ji'>ꜱᴜʙꜱᴄʀɪᴘᴛɪᴏɴ ᴘʀᴏᴏꜰ</a>
...
ɪꜰ ʏᴏᴜ ꜰᴀᴄᴇ ᴀɴʏ ᴘʀᴏʙʟᴇᴍ, ᴛᴀᴋᴇ ᴀ ꜱᴄʀᴇᴇɴꜱʜᴏᴛ ᴀɴᴅ ꜱᴇɴᴅ ɪᴛ ᴛᴏ - @Baii_Ji
...
👨‍💻 ᴄᴏɴᴛᴀᴄᴛ ᴛʜᴇ <a href='https://t.me/Baii_Ji'>Owner</a> ᴛᴏ ɢᴇᴛ ʏᴏᴜʀ ᴛʀɪᴀʟ.
...
ꜱᴏᴜʀᴄᴇ ᴄᴏᴅᴇ ʜᴇʀᴇ ◉› :<a href=https://t.me/Baii_Ji>Cᴏɴᴛᴀᴄᴛ Oᴡɴᴇʀ</a>\n """
