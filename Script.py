...
├⍟ Mʏ Nᴀᴍᴇ : <a href=https://t.me/OttSandhu{}>{}</a>
...
Mᴇꜱꜱᴀɢᴇ : <b>{}</b>"""
    ...
    MOVIE_UPDATE_NOTIFY_TXT = """<b>​​​【{filename}】🆕️\n\n🎭 Gᴇɴʀᴇs: {genres}\n📺 Oᴛᴛ: {ott}\n\n🎞️ Qᴜᴀʟɪᴛʏ: {quality} 720p, 1080p, etc.\n🎧 Aᴜᴅɪᴏ: {language}\n⭐️ IMDb: {rating}★\n\n<blockquote>👑 Pʀᴏᴠɪᴅᴇᴅ Bʏ : @OttSandhu</blockquote></b>"""
