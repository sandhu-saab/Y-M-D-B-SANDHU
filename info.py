...
API_ID = int(environ.get('API_ID', '29882686')) # API ID from my.telegram.org
API_HASH = environ.get('API_HASH', 'b642a25aee67b2aed02116df4a916bca')  # API Hash from my.telegram.org
...
# FORCE_SUB 
auth_req_channels = environ.get("AUTH_REQ_CHANNELS", "-1002059202729")# requst to join Channel for force sub (make sure bot is admin) only for bot ADMINS  
auth_channels     = environ.get("AUTH_CHANNELS", "-1002429510787")# Channels for force sub (make sure bot is admin)

# ============================
# Payment Configuration
# ============================
QR_CODE = environ.get('QR_CODE', 'https://i.ibb.co/dssRwfd4/photo-2025-06-29-08-16-42-7521282330015563796.jpg')    # QR code image for payments
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', 'sukhwindersingh48396-3@okhdfcbank')    # Owner UPI ID for payments
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://sukhwindersingh010160:singh1016@cluster0.dyvbt33.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")  # MongoDB URI for the database
DATABASE_NAME = environ.get('DATABASE_NAME', "sukhwindersingh010160") # Database name (default: cluster)
...
TUTORIAL = environ.get("TUTORIAL", "https://t.me/+dVRLYHXJztJlMmY9")   # Tutorial link for verification
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/+dVRLYHXJztJlMmY9")   # Second tutorial link for verification
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/+dVRLYHXJztJlMmY9")   # Third tutorial link for verification

# Verification (Must Fill All Veriables. Else You Got Error
SHORTENER_API = environ.get("SHORTENER_API", "d69bdc9eeef4d1cb0d2bb9733099a0282bdc64ac") # Shortener API key
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", "linkshortify.com") # Shortener website

SHORTENER_API2 = environ.get("SHORTENER_API2", "d69bdc9eeef4d1cb0d2bb9733099a0282bdc64ac")  # Shortener API key for second website
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+xid7xzHRfucyMjc1') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/Baii_Ji') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/+U6OK4EJBjCdlNjA9') # Update channel link for the bot
...
# ============================
MAX_B_TN = environ.get("MAX_B_TN", "4") # Maximum number of buttons in a row (default: 5)
